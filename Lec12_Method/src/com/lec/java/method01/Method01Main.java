...
public class Method01Main {
	...
	public static void main(String[] args) {
		...
		sayAge(16);
		sayAge(20);
		//void com.lec.java.method01.Method01Main.sayAge(30);
		System.out.println();// 메소드 호출 구문
		
		sayHello2("김우경", 25);
		// 정의되어 있는 매개변수 리스트와 다르게 호출하려 하면 
		// sayHello2(100, 200); //not applicable for the arguments (int, int
	...
	public static void sayHello(String name) {   
		System.out.println("안녕하세요");
		System.out.println("제 이름은 " + name +" 입니다."); //정의 
	}
