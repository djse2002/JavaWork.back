...
public class Generic01Main {
	...
	public static void main(String[] args) {
		...
		FruitBox<Orange> oranBox2 = new FruitBox<Orange>(orange2);
		oranBox2.pullOut().displaySugar();
		
		Apple apple2 = new Apple(50);
		FruitBox<Apple> apBox = new FruitBox<Apple>(apple2);
		appleBox1.pullOut().displayWeight();
		
		Banana banana2 = new Banana(300);
		FruitBox<Banana> banaBox2 = new FruitBox<Banana>(banana2);
		banaBox2.pullOut().displayNum();
...
class OrangeBox{
	...
	public OrangeBox(Orange orangae) {
		super();
		this.orange = orangae;
	}
