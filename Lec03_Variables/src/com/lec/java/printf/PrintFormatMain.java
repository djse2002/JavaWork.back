package com.lec.java.printf;/* 서식화된 문자열 (formatted string)
 *  ● 화면에 출력할때는 -> printf()
 *    
 *    printf("서식문자열", 값1, 값2....)
 *    
...
public class PrintFormatMain {
	...
	public static void main(String[] args) {
		...
		System.out.printf("원주열 %f\n" ,pi);
		System.out.printf("원주열 %.2f\n",pi);
		
		int age= 10;
		short grade =3;
		
		System.out.printf("제 나이는 %d살 입니다. 학년은 %d 학년 입니다.\n", age,grade);
		...
		String.format("합격률은 %1.1f%% 입니다", rate); //화면 출력용이 아님
		String result = String.format("합격률은 %1.1f%% 입니다", rate);
