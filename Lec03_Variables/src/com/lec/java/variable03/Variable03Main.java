...
public class Variable03Main {
	...
	public static void main(String[] args) {
		...
		//실수 타입 최소, 최대값
		System.out.println("float :" + Float.MIN_VALUE +"~" + Float.MAX_VALUE); //1.4 * 10의 -45승 
		System.out.println("double :" + Double.MIN_VALUE +"~" + Double.MAX_VALUE); // 10의 -324승 ,10의 308승 
		...
		// float 와 double은 저장할 수 있는 값의 크기만이 아니라 소수점 이하 정밀도(precision)의 차이가 있다.

		// 실수 표기법
		 double number6 = 123; //int 가 double 로 자동 변환 됨 123.0 
		 double number7 = 1.23e2; // 지수 표기법(exponential notatoin)
