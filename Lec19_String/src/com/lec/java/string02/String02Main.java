...
public class String02Main {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println("[1] String literal 사용");  // literal은 직접 입력하는 값
		...
		// TODO
		System.out.println("compareTo : " + str3.compareTo(str4)); // 완전히 문자열이 같으면 0
		
		String str5 = "A";
		String str6 = "C";
		System.out.println("compareTo : " + str5.compareTo(str6)); // 완전히 문자열이 같으면 0
		System.out.println("compareTo : " + str6.compareTo(str5)); // 완전히 문자열이 같으면 0
