...
public class RegExp03Main {
	...
	public static void main(String[] args) {
		...
		regex = "^The"; // TODO The 로 시작하는 문자열 패턴
		arrInput = new String[] {
				// TODO
				"The Things",
				"On The Things",
		...
		regex = "Man$"; // TODO Man 으로 끝나는 문자열 패턴
		arrInput = new String[] {
				// TODO
				"SuperMan",
				"AquaMan",
		...
		regex = "[abc]"; // TODO //a 또는 b 또는 c 중의 한 문자에 매칭
		arrInput = new String[] {
				// TODO
				"able",
				"bible",
		...
		regex = "ab{3,5}"; //b의 개수가 3개 부터 5개 까지
		
		//─────────────────────────────────────────
		title = " () : ()안에 있는 글자들을 그룹화 ";
		regex = "a(bc)*"; // TODO (bc) 가 없거나 하나 이상
		arrInput = new String[] {
				// TODO
				"abc",
				"abcbcbbc",
		...
		regex = "\\s+"; // TODO 공백 (스페이스바, 줄바꿈 , 탭) 한개 이상
		arrInput = new String[] {
				// TODO
				"Hello My World",
				"He \tllo My World",
