...
public class Input04Main {
	...
	public static void main(String[] args) {
		...
		//int i1 = sc.next();//문자열을 int절에 담을수 없다. 에러
		String in1 = sc.next();				
		int i1 = Integer.parseInt(in1); //String으로 변환받은 in1을 int1로 변환
		...
		//TODO
		// 실수 3개를 문자열로 입력받아서 (nxet()) 3실수의 곱을 계산하여 출력하세요
		
		System.out.println("실수 3개(doubel,doubel,doubel)을 입력받으세요");
