...
-- 사원의 인덱스
SELECT empno , rowid FROM T_EMP ;  --ROWID, ROW INSERT 될때 마다 부여됨, SELECT 시 기본적으로 참조
...
INSERT INTO T_DEPT2  VALUES (9100, '임시매장',1600,'서울지사');

INSERT INTO T_DEPT2  VALUES (9101, '임시매장',1600,'부산지사');
 ...
 * 
 */
CREATE INDEX ind_prof_pay_fbi ON t_professor (pay + 100);
