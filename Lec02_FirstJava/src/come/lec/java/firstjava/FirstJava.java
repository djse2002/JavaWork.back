package come.lec.java.firstjava;
/*
...
//		System.out.println(안녕하세요); // 에러   ctrl + / 한줄 주석 
		...
		System.out.println("안녕하세요" + "여러분");  //안녕하세요여러분
		System.out.println("결과: " + 10);  		//10을 문자로 변환하여 연결
		System.out.println("결과: " + 10 + 20);  // 왼쪽 + 먼저 수행 후 뒤 + 수행
