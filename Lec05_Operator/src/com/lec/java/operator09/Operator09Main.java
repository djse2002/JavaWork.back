...
public class Operator09Main {
	...
	public static void main(String[] args) {
		...
		//f3 = f1 + d1; // 오류 float + double --> double
		...
		// 자바의 연산결과 타입규칙과 기본 데이터 타입의 한계값 인지 하고 있어야 한다.
		
		// 복합대입연산자
		int sum = 0;
		double d4 = 1.2;
		
		//sum = sum + d4 //int + double --> double 임으로 오류 
		sum += d4;
		System.out.println("sum= " + sum);
		
		// sum += d4 복합대입연산자는 sum = sum + d4가 아니라 sum = (iut)(sum + d4) 으로 동작함
